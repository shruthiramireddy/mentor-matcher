                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                        ...
                        {activeTab === "meeting-notes" && (
                          <div className="flex items-center gap-1">
                            ...
                            <span>With {(selectedNoteData as any).partner}</span>
                          </div>
                        )}
                        {activeTab === "journal" && (
                          <div className="flex items-center gap-1">
                            <span className="rounded-full bg-pink-100 px-2 py-0.5 text-pink-800">
                              {(selectedNoteData as any).mood}
                            </span>
                          </div>
                        )}
                      </div>
                      ...
                      {activeTab === "meeting-notes" && (
                        <>
                          <div>
                            ...
                            {isEditing ? (
                              <Textarea
                                defaultValue={(selectedNoteData as any).reflections}
                              ...
                              <div className="rounded-lg border bg-gray-50 p-4 text-gray-700">
                                {(selectedNoteData as any).reflections}
                              </div>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(selectedNoteData as any).tags.map((tag: string) => (
